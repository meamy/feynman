...
simQASM' :: QASM -> Maybe Env -> Env
simQASM' (QASM _ _ stmts) Nothing    = execState (mapM_ simStmt stmts) initEnv
simQASM' (QASM _ _ stmts) (Just env) = execState (mapM_ simStmt stmts) env
